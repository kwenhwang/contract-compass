...
LAW_MANIFEST: tuple[LawSpec, ...] = (
    ...
    # 국유·공유재산 사용허가의 '다른 법률상 우선허가' 예외 근거 (2026-07-31 제보
    # mcp-40204229b381: 청사 매점·자판기 사용허가 검토 중 제42조 404)
    LawSpec("장애인복지법.xml", "장애인복지법",
            note="제42조 공공시설 매점·자판기 우선 허가 — 국유재산법 제30조 검토 시 동반 인용"),
    LawSpec("장애인복지법_시행령.xml", "장애인복지법 시행령"),
)
