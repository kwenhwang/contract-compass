// 디자이너(Zippt AI) Lucide icon set 인라인 SVG.
// 24x24 viewBox, stroke 2, round caps. <Icon name="x" size={18} strokeWidth={2} className=".." />
...
export default function Icon({
  name, size = 20, className = '', strokeWidth = 2, style,
}: {
