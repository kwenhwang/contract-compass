...
const TONES: Record<string, { fg: string; bg: string; solid: string; line: string }> = {
  ...
  warning: { fg: 'var(--med-ink)',               bg: 'var(--warning-soft)',   solid: 'var(--warning)',        line: 'rgba(245,158,11,0.30)' },
  ...
  purple:  { fg: 'var(--cat-complex-fg)', bg: 'var(--cat-complex-bg)', solid: 'var(--violet)',               line: 'rgba(124,58,237,0.26)' },
